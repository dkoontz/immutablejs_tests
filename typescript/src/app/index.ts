...
import { CommitStoreRecord } from "./interfaces";
import { CommitMessageStore } from "./CommitMessageStore";
...
function compareStores(store1 : CommitStoreRecord, store2 : CommitStoreRecord)
{
